 ...
 */
final class Version20190729120707 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_47948BBC8CDECFD5 ON depot (idcompte_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_47948BBC8CDECFD5 ON depot');
